...
public class EntityModeFreedomEX extends EntityModeBasic {
	...
	public EntityModeFreedomEX(EntityLittleMaid pEntity) {
		super(pEntity);
	...
	public void addEntityMode(EntityAITasks pDefaultMove, EntityAITasks pDefaultTargeting) {
		...
		Itasks[1].addTask(1, new EntityAIHurtByTarget(owner, true));
		Itasks[1].addTask(2, new EntityAINearestAttackableTarget(owner, EntityPlayerMP.class, 0, true));
	...
	public void showSpecial(RenderLittleMaid prenderlittlemaid, double px, double py, double pz) {
		if (owner.isContract() && LittleMaidConfig.enableDisplaySugarCount) {
